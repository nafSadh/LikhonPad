    ...
    partial class JuktiKendro
    {
        ...
        private static BanglaBornoResultSet isByanjon(char romok, char romok_1)
        {
            ...
            switch (romok)
            {
                ...
                case 'G':
                    return byanjonborno.SetVal(1, "জ্ঞ");
                case 'q':
                    switch (romok_1)
                    {
                        case 'h':
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            if (borno1.Borno == BanglaBorno.Chihno._forceKar) { isKarNeeded = true; borno = borno1; }
                            else
                            {
                                borno = borno1;
                    ...
                    if (!sworeokaarghotona && borno.Borno!=BanglaBorno.Chihno._forceKar)
        ...
        public static string parseWrite(string inputText)
        {
            ...
            while (i < inputs.Length)
            {
                ...
                else if (inputs[i] == "HX" || inputs[i] == "hx")
                {
                    if (i + 1 < inputs.Length)
                        outPut.Append(LikhonPad.htmlUnicode.bn2htmlhex(inputs[++i]));
                }
                else if (inputs[i] == "UNHX" || inputs[i] == "unhx")
                {
                    if (i + 1 < inputs.Length)
                        outPut.Append(LikhonPad.htmlUnicode.htmlhex2bn(inputs[++i]));
                    outPut.Append("--");
                }
                ...
                else if (inputs[i] == "dev" || inputs[i] == "DEV")
                {
                    if (i + 1 < inputs.Length)
                        outPut.Append(LikhonPad.bn_dev.bn2dev(inputs[++i]));
                }
                else if (inputs[i] == "brah" || inputs[i] == "BRAH")
                {
                    if (i + 1 < inputs.Length)
                        outPut.Append(LikhonPad.Brahmi.bn2brah(inputs[++i]));
                }
                else if (inputs[i] == "dev-bn" || inputs[i] == "DEV-BN")
                {
                    if (i + 1 < inputs.Length)
                        outPut.Append(LikhonPad.bn_dev.dev2bn(inputs[++i]));
                }
                else if (inputs[i] == "bn-en" || inputs[i] == "BN-EN")
                {
                    if (i + 1 < inputs.Length)
                        outPut.Append(LikhonPad.Bn2En.bengaliTranslit(inputs[++i]));
                }
                else if (inputs[i] == "en-ka" || inputs[i] == "en-ka")
                {
                    if (i + 1 < inputs.Length)
                        outPut.Append(LikhonPad.Gerogian.en2ka(inputs[++i]));
                }
                else
                {
                    outPut.Append(ns7.bhaswor.LikhonPad.JuktiKendro.RomokThekeBangla(inputs[i]));
